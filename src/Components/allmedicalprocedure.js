  ...
  const displayUsers = medicals
    ...
    .filter((location) => {
      if (searchTerm === "") {
        ...
        location.medical_procedure_label
          .toLowerCase()
          .includes(searchTerm.toLowerCase())
      ) {
        return medicals;
      } else if (
        location.medical_procedure_name
          .toLowerCase()
          .includes(searchTerm.toLowerCase())
      ) {
        return medicals;
      } else if (
        location.medical_procedure_types
          .toLowerCase()
          .includes(searchTerm.toLowerCase())
      ) {
        return medicals;
      ...
      // }
        ...
        location.medical_procedure_description
          .toLowerCase()
          .includes(searchTerm.toLowerCase())
      ) {
        return medicals;
        ...
        <tr>
          ...
          <td>
            <Link
              ...
              onClick={() =>
                UpdateMedicalProcedure(location.medical_procedure_id)
              }
            >
              View
            </Link>
