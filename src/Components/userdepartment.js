        ...
        return (
          <div>
             <div className="contact pt-5  d-flex justify-content-between">
                ...
                <div className="font-weight-bold h5">Department Label: {meds.department.department_profile_label}</div>
                </div>
                <div className="contact pt-3 pb-3 d-flex justify-content-between">
                <div className="font-weight-bold h5">Department Name: {meds.department.department_profile_name}</div>
                </div>
                <div className="contact pt-3 pb-3 d-flex justify-content-between">
                <div className="font-weight-bold h5">Department Description: {meds.department.department_profile_description}</div>
                </div>
                {/* for Input Feild */}
                    <Form onSubmit={handleSubmit}>
                    <Row xs="1" sm="2" md="3" lg="2">
                            <Col> <Form.Group className="mb-4" controlId="#">
                                <Form.Label><small className="text">New Department</small></Form.Label>
                                <select
                                name="deptId"
                                value={values.deptId}
                        ...
                        <div className="pb-5">
                            <button className="btn1" href="/User1">Update</button>
